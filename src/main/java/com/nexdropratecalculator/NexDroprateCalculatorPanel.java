...
public class NexDroprateCalculatorPanel extends PluginPanel {
  ...
  void updateValues(
    ...
    uniqueRollCombined.setText(labelValue("Combined Unique Roll", String.format(fraction(averageRun.getRunAverageUniqueChanceRoll()/averageRun.getRunAverageTotal())) + "%"));
  }
